...
public class QianShi {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0;i<jsonArray.size();i++){
            ...
            String url = "https://xuangubao.cn/stock/" + jsonres.getString("symbol");
            ...
            zhangting.setUrl(url);
            zhangting.setBianma(Util.change16(name));
    ...
    public static void format(Map<String,List<Zhangting>> map ) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter("F:\\IdeaProjects\\gupiao\\src\\main\\resources\\qiangshi.opml"));
        ...
        for(String key : map.keySet()){
            ...
            for(Zhangting z : list){
                writer.write("      <outline text=\"mingzi\" _mubu_text=\"%3Ca%20class=%22content-link%20text-color-red%22%20href=%22wangzhi%22%3E%3Cspan%20class=%22content-link-text%22%3Ebianma%3C/span%3E%3C/a%3E\" >".replace("mingzi",z.getName()).replace("wangzhi",z.getUrl()).replace("bianma",z.getBianma()));
                writer.newLine();
